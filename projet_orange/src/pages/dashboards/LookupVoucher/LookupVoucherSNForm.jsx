...
const LookupVoucherSNForm = () => {
  ...
  const handleSend = () => {
    if (msisdn.length !== 12) {
      setError("Le numéro de série doit contenir exactement 12 chiffres.");
    } else {
      setError("");
      console.log("Sending Serial Number:", msisdn);
      
      // Navigate to vs/info page with serial number as parameter
      navigate(`/vs/info?serial=${msisdn}`);
      ...
      // navigate('/vs/info', { state: { serial: msisdn, type: 'serial' } });
    }
  };
...
export default LookupVoucherSNForm;