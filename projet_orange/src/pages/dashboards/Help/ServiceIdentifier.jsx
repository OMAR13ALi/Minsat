...
const [serviceIdentifierData, setServiceIdentifierData] = useState([]);
  ...
  useEffect(() => {
    setServiceIdentifierState(prev => ({ ...prev, filteredData: serviceIdentifierData }));
  }, []);
  ...
  return (
    <div style={{... containerStyle, height: '100vh', marginTop: '-30px', overflowY: 'auto' }}>
      ...
      <DataTable
        ...
        icon="▲"
        data={serviceIdentifierData}
        columns={serviceIdentifierColumns}
        state={serviceIdentifierState}
        setState={setServiceIdentifierState}
