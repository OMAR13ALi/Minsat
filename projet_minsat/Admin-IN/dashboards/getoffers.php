    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="../dashboards"><img src="img/logoas.png" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="../dashboards"><img src="img/logoas-mini.png" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  ...
                  <span class="text-secondary text-small">Support-IN</span>
                </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="getoffers">Account</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="changestatus">Change Status</a></li>
                </ul>
              </div>
            </li>
...
<form action="getoffers" class="forms-sample" name="form1" method="post" style="transform:translate(80px)" > 
<table >
<tr>
...
<a href="http://10.7.24.2/minsat/dashboards/getoffers"><button type="submit"  class="btn btn-light" style="transform:translate(265px,20px)">Clear</button></a>
</td>
</tr>
