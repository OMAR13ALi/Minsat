...
<form action="serialnumber" class="forms-sample" name="form1" method="post" style="transform:translate(80px)" > 
<table >
<tr>
<td align="center" colspan="2">
<label for="nbvouchers">Lookup : <b>Serial Number</b></label>
</td>
<td>
<input type="text" class="form-control" id="nbvouchers" pattern="[0-9]*" style="width:263px;height:40px;font-size:15px" maxlength="12" name="lookup" value="<?php if(isset($_POST['submit'])){ echo $_REQUEST["lookup"];} else { echo  "";}?>" required>
</td>
</tr>
...
<a href="http://10.13.64.59/minsat/dashboards/serialnumber"><button type="submit"  class="btn btn-light" style="transform:translate(265px,10px)">Clear</button></a>
</td>
</tr>
...
$role=$_SESSION['role'];
$sn=$_POST["lookup"];
$sqlss="insert into audit (`login`,`role`,`datesn`,`ip`,`os`,`browser`,`serialnumber`) 
values ('".$user."','".$role."','".$datee."','".$ip."','".$os."','".$browser."','".$sn."')  ";
...
<th style="border-width:1px;border-color: black;border-style: dotted"><b>Value</b></th>
 </tr>
</thead>
