            ...
            <div class="page-header">
              <h3 class="page-title">
                <span class="page-title-icon bg-gradient-primary text-white me-2">
                  <i class="mdi mdi-image-filter-center-focus menu-icon"></i>
                </span> Usage Counter
              </h3>
...
<table id="a" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">Counter</th>
        ...
        <tbody>
		<?php
$querysc= "select * from usagecounters ";
...
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["counter"]);  ?></td>		
