...
<li class="nav-item active">
              ...
              <div class="collapse" id="ui-basic3">
				...
				<li class="nav-item"> <a class="nav-link" href="iloIN">ILO_IN</a></li>
                  ...
                  <li class="nav-item active"> <a class="nav-link" href="autochecks">Automated Checks</a></li>
                </ul>
              </div>
            </li>
...
<div class="content-wrapper">
			...
			<div id="main_section">
		<div id="nodes_box">
				<div id="selected_date_box">
					<h2 id="selected_date">Des chèques pour: <?php echo $day."-".$month."-".$year." numéro d'itération ".$iteration ?></h2>
					<div id="node_selection_area">
					
						<div id="select_node_box">
					
							<ul class="nodelist" id="nodes_list">
								<li><a href="SDP?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="sdp_checks">SDP</a></li>
								<li><a href="AIR?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="air_checks">AIR</a></li>
								<li><a href="OCC?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="occ_checks">OCC</a></li>
								<li><a href="CCN?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="ccn_checks">CCN</a></li>
								<li><a href="NGVS?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="ngvs_checks">NGVS</a></li>
								<li><a href="NGCRS?date=<?php echo $dir1; ?>&Iteration=<?php echo $iteration; ?>" id="ngcrs_checks">NGCRS</a></li>
							</ul>
						</div>
