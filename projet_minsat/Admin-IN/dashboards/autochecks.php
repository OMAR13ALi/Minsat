...
<div class="content-wrapper">
	...
	<div id="checks_main_section">
		
			<div id="gather_info_box">
				<div id="info_box_title">
					<center><h1 style="color:black;font-size: 25px;">Cet outil est utilisé pour vérifier quotidiennement les nœuds IN</h1></center>
					<div id="data_box">
						<form action="nodeselect" method="GET">
							<input type="text" id="date_box" value="Veuillez sélectionner la date" style="border-radius:10px; width:310px; border:2px solid #f60; font-size:21px; font-family:tahoma; font-weight:bold; padding:5px; color:#000; text-align: center;" />
								<select name="day" id="day_list" style="transform:translate(60px)">
									<option selected="selected"><?php $today_day = date("d"); echo $today_day ?></option>
									<option>01</option>
									<option>02</option>
									<option>03</option>
									<option>04</option>
								...
								<select name="month" id="month_list" style="transform:translate(60px)">
									<option selected="selected"><?php $today_month = date("m"); echo $today_month ?></option>
									<option>01</option>
									<option>02</option>
									<option>03</option>
									<option>04</option>
								...
								<select name="year" id="year_list" style="transform:translate(60px)">
									<option selected="selected"><?php $today_year = date("Y"); echo $today_year ?></option>
									<option>2023</option>
									<option>2024</option>
									<option>2025</option>
									<option>2026</option>
								...
								<input type="text" id="iteration_box" value="Veuillez sélectionner l'itération" style="border-radius:10px; width:340px; border:2px solid #f60; font-size:21px; font-family:tahoma; font-weight:bold; padding:5px; color:#000;" />
								<select name="iteration" id="iteration_list" style="transform:translate(160px)">
									<option selected="selected">1</option>
									<option>2</option>
									<option>3</option>
								</select>
								<input type="submit" id="submit_button" value="Submit" style="height:50px; border-radius:10px; width:120px; border:2px solid #FF6500; font-size:26px; font-family:tahoma; padding:5px; text-align:center; background-color:#FF6500; cursor: pointer; color:white;" />
						</form>	
					</div>
				</div>
