...
<form action="getmsisdninformation" class="forms-sample" name="form1" method="post" style="transform:translate(80px)" > 
<table >
<tr>
...
<a href="http://10.13.64.59/minsat/dashboards/getmsisdninformation"><button type="submit"  class="btn btn-light" style="transform:translate(265px,20px)">Clear</button></a>
</td>
</tr>
...
$role=$_SESSION['role'];
$msisdn=$_POST["msisdn"];
$sqlss="insert into audit (`login`,`role`,`dateinfo`,`ip`,`os`,`browser`,`msisdnaccinfo`) 
values ('".$user."','".$role."','".$datee."','".$ip."','".$os."','".$browser."','".$msisdn."')  ";
$resultss=mysqli_query($connect,$sqlss);	
// $sqlss="update audit set msisdnaccinfo='$msisdn' where login='$user' and sessionin like '$datee%'  ";
// $resultss=mysqli_query($connect,$sqlss);
...
elseif($accountId2 > 799)
{
echo $valuesssso22=$value2;
}
else
{
...
elseif($accountId > 799)
{
echo $valuessssooo=$value;
}
else
{
...
if($offerID2=="50000")
{
$startDateofferoffer = $offer['struct']['member'][4]['value']['dateTime.iso8601'];
$startoffer2offer=date_create($startDateofferoffer);
$starttoffer2offer=date_format($startoffer2offer, 'Y-m-d H:i');
echo $starttoffer2offer ;
}
else
{
echo $starttoffer2;
...
elseif($offerID2=="50004")
{
	echo $provideriddata222 = $dataoffer['params']['param']['value']['struct']['member'][0]['value']['array']['data']['value']['struct']['member'][2]['value']['string'];
}
else
{
echo " ";
...
{
$startDateofferoffer1 = $offer['struct']['member'][4]['value']['dateTime.iso8601'];
$startoffer2offer1=date_create($startDateofferoffer1);
$starttoffer2offer1=date_format($startoffer2offer1, 'Y-m-d H:i');
echo $starttoffer2offer1 ;
}
else
{
echo $starttoffer;
...
elseif($accountIdoffer=="50004")
{
	echo $provideriddata11 = $offer['struct']['member'][2]['value']['string'];
}
else
{
echo " ";
