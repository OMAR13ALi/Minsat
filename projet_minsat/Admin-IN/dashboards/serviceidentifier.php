...
<html lang="en">
  <head>
    ...
    <title>Admin-IN : Service Identifier</title>
    <!-- plugins:css -->
...
<table id="a" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">Id</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Name</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Context</th>
            </tr>
			<tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">Id</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Name</th>
        ...
        <tbody>
		<?php
$querysi= "SELECT Id33,Comment34, substring_index(Comment,'context',1) as description FROM `serviceidentifier` where Id33 not like '' order by Id33 desc  ";
...
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["Id33"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["Comment34"]);  ?></td>		
