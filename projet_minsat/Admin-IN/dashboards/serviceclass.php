...
<html lang="en">
  <head>
    ...
    <title>Admin-IN : Service Class</title>
    <!-- plugins:css -->
            ...
            <div class="page-header">
              <h3 class="page-title">
                <span class="page-title-icon bg-gradient-primary text-white me-2">
                  <i class="mdi mdi-sd menu-icon"></i>
                </span> Service Class
              </h3>
...
<table id="a" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">SC_ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Offre</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">DA Group</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Catégorie</th>
            </tr>
			 <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">SC_ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Offre</th>
        ...
        <tbody>
		<?php
$querysc= "select * from serviceclasses ";
$resultsc = mysqli_query($connect,$querysc);
while($row = mysqli_fetch_array($resultsc)) {                                	
?>
<tr style="border-width:1px;border-color: black;border-style:dotted">	
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["sc"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["offre"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["dagroup"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["cat"]);  ?></td>			
</tr>
<?php
}
?>		
...
<table id="b" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">DA group ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">DA ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Description</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Unit Type</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Usage</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Category</th>
            </tr>
			<tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">DA group ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">DA ID</th>
        ...
        <tbody>
		<?php
$querysi= "SELECT * FROM `dagroups`  order by  DEFINITION_GROUP_ID  asc  ";
$resultsi = mysqli_query($connect,$querysi);
while($row = mysqli_fetch_array($resultsi)) {                                	
?>
<tr style="border-width:1px;border-color: black;border-style:dotted">	
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["DEFINITION_GROUP_ID"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["DEDICATED_ACCOUNT_ID"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["DESCRIPTION"]);  ?></td>			
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["UnitType"]);  ?></td>			
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["Usage"]);  ?></td>			
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["category"]);  ?></td>			
</tr>
<?php
}
?>		
...
<center>
<table id="c" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                <th style="border-width:1px;border-color: black;border-style:dashed">UA ID</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">Description</th>
            </tr>
			<tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                  <th style="border-width:1px;border-color: black;border-style:dashed">UA ID</th>
        ...
        <tbody>
		<?php
$querysi= "SELECT * FROM `uagroup`   ";
$resultsi = mysqli_query($connect,$querysi);
while($row = mysqli_fetch_array($resultsi)) {                                	
?>
<tr style="border-width:1px;border-color: black;border-style:dotted">	
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["ua"]);  ?></td>		
<td style="border-width:1px;border-color: black;border-style:dotted"><?php echo utf8_encode($row["description"]);  ?></td>				
</tr>
<?php
}
