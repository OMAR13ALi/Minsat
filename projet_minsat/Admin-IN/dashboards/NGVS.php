...
<table id="a" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                ...
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1NGVS1a</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1NGVS1b</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1NGVS1c</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN2NGVS2a</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN2NGVS2b</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN2NGVS2c</th>
            </tr>

        </thead>
        <tbody>
<?php
if (($csvfile= fopen("../../OTN_HealthChecks/NGVS/".$date_dir."/".$iteration."/checksNGVS.csv", "r")) !==FALSE)
{ 
...
<br/>
		...
		var memberA_table = document.getElementById("NGVS_table");
		var filename = "../../OTN_HealthChecks/NGVS/"+<?php print($date_dir); ?>+"/"+<?php print($iteration); ?>+"/"+"NGVS_"+col+"_"+row;
		var myWindow = window.open(filename,"MsgWindow","width=800,height=600");
		}

		
		$(document).ready(function(){
			$('#NGVS_table td.table_values').each(function(){
				if ($(this).text() == '[NOK]') {
