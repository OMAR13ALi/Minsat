...
<table id="a" class="display" style="width:100%">
        <thead>
            <tr style="background:#ff6600; color:#fff;font-weight: bold;border-style: dashed;height:30px">
                ...
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1OCC1</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1OCC2</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1OCC3</th>
                <th style="border-width:1px;border-color: black;border-style:dashed">TN1OCC3</th>
            </tr>
        ...
        <tbody>
<?php
if (($csvfile= fopen("../../OTN_HealthChecks/OCC/".$date_dir."/".$iteration."/checksOCC.csv", "r")) !==FALSE)
{ 
...
<br/>
		...
		<script type="text/javascript">
            ...
            var memberA_table = document.getElementById("OCC_table");
            var filename = "../../OTN_HealthChecks/OCC/"+<?php print($date_dir); ?>+"/"+<?php print($iteration); ?>+"/"+"OCC_"+col+"_"+row;
            var myWindow = window.open(filename,"MsgWindow","width=800,height=600");
            }

            
            $(document).ready(function(){
                    $('#OCC_table td.table_values').each(function(){
                            if ($(this).text() == '[NOK]') {
