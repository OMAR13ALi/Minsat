<?php 
// $redirect= "https://10.7.24.2:8080/minsat";

// header("Location:$redirect"); 
// if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] === "off") {
    // $location = 'https://10.7.24.2:8080/minsat';
...
<body class="login-page">
    <div class="container-fluid">
        ...
        <div class="row align-item-center">
                            ...
                            <div role="group" class="form-group">
                                ...
                                <div>
                                    <div role="group" class="input-group">
                                        <input id="username" type="text" name="username" required="required" placeholder="Username" class="form-control input-transparent pl-3">
                                    </div>
                                </div>
                            </div>
                            <div role="group" class="form-group">
                                ...
                                <div>
                                    <div role="group" class="input-group">
                                        <input id="password" type="password" name="password" required="required" placeholder="Password" class="form-control input-transparent pl-3">
                                    </div>
                                </div>
                            </div>
            ...
            <img src="img/4905827.jpg" class="singin" alt="signin">
        </div>

        <footer class="page-footer" style="transform:translate(0px,10px)">
           &copy; 2024 Admin-IN. All Rights Reserved | Design by DRS <a href="http://village.orangetunisie.intra/"><img src="img/orange.png" style="width:15px; transform:translate(5px,-02px)"></a>
        </footer>
        </main>
    </div>
